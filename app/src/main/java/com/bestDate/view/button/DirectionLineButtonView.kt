...
class DirectionLineButtonView @JvmOverloads constructor(
    ...
    init {
        setAttrs(attrs, R.styleable.DirectionLineButtonView) {
            binding.buttonBackground.setBackgroundResource(it.getResourceId(R.styleable.DirectionLineButtonView_button_background, R.drawable.buttons_box))
            binding.icon.setImageResource(it.getResourceId(R.styleable.DirectionLineButtonView_button_image, R.drawable.ic_profile))
